...
public class UI_Button_Cannon extends UIButton {

    public UI_Button_Cannon() {
        super(32, 32);

        setInteractCode(InteractCode.SPAWN_C);
        ...
        UITextBox priceText = new UITextBox("$500", 8, Color.WHITE);
