...
public class FireAcher extends Tower {
    public FireAcher(Point2D position, Collision searchRadius, Collision placementRadius, Weapon weapon, SpriteEngine spriteBody) {
